...
//========party2=======//
mapFor.forEach(function (value, key) {
    console.log(value);
    if (key % 3 === 0) {
        console.log("".concat(key, " divaded the 3"));
    }
    if (key % 5 === 0) {
        console.log("".concat(key, " oops here is 5"));
    }
    else if (key % 3 === 0 && key % 5 === 0) {
        console.log("".concat(key, " i can beelive that"));
    }
});
//===========party3=========//
var arr = [["36", "не приватизирован", "4 собственника", "Парковая"],
    ["45", "приватизирован", "3 собственника", "Луговая"],
    ["56", "не приватизирован", "1 собственник", "Луговая"],
    ["56", "приватизирован", "5 собственников", "Ленина"],
    ["25", "не приватизирован", "2 собственника", "Ленина"]];
arr.forEach(function (item) {
    var numHome = Number(item[0]);
    var streetHome = item[3];
